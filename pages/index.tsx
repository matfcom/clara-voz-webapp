...
export default function ClaraApp() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-4 space-y-4">
      ...
      <Textarea value={transcript} readOnly placeholder="Lo que has dicho" className="w-full max-w-xl" />
      <Textarea value={response} readOnly placeholder="Respuesta de Clara" className="w-full max-w-xl" />
    </div>
  );
}
